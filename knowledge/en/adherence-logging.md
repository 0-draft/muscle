---
title: A System for Keeping a Log
summary: Logging alone is not enough; feedback against your goals is what works. Keep it under 30 seconds, tie it to a cue, and don't punish missed days.
area: adherence
order: 30
...
> [!A] Monitoring progress makes goals more likely to be reached. The effect is larger when you **physically record it** on paper or in a file, and larger still when you **make it public**.
...
> [!A] Specific "if X happens, I will do Y" plans (implementation intentions) improve goal attainment by a medium to large amount. For exercise alone, the effect is smaller.
...
> [!B] The median time to form a habit is about 2 months. Individual variation is very large, from 4 to 335 days.
...
> [!C] Missing one day has little effect on habit formation.
...
> [!B] People keep going when they enjoy it or are intrinsically motivated. Feeling forced does not last.
...
> [!B] Tracker use drops over time: 74% after 100 days, 16% after 320 days. The main reason for quitting is technical problems.
...
> [!C] People who weigh themselves daily lose more weight, with no sign of psychological harm.
...
> [!D] Daily body weight moves with water, glycogen, salt, and gut contents. Use only the 7-day average and its week-to-week change for decisions.

## Goal setting

> [!A] Setting goals changes behavior. The effect is larger when goals are difficult and when they are made public.
...
> [!B] Self-reported RIR is off by about 1 rep on average. It is more accurate closer to failure and less accurate on high-rep sets.
