...
3. Read `goals.md` and `program/ja/current.md`.
...
- A muscle outside 10–20 weekly sets is worth mentioning only if it is off-plan, not because of a missed session.
